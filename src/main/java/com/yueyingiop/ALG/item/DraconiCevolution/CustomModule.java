...
public class CustomModule {
    ...
    public static final DeferredHolder<Module<?>, Module<?>> CREATE_ENERGY = MODULES != null ? MODULES.register(
        ...
        () -> {
            ...
            System.out.println("[ALG] "+MODULES.getRegistryName().toString());
    ...
    // 创造护盾控制器
    public static final DeferredHolder<Module<?>, Module<?>> CREATE_SHIELD_CONTROL = MODULES != null ? MODULES.register(
    ...
    // 创造大型护盾增强
    public static final DeferredHolder<Module<?>, Module<?>> CREATE_LARGE_SHIELD_CAPACITY = MODULES != null ? MODULES.register(
    ...
    // 混沌自动进食
    public static final DeferredHolder<Module<?>, Module<?>> CHAOTIC_AUTO_FEED = MODULES != null ? MODULES.register(
        "chaotic_auto_feed",
        () -> {
            ModuleImpl<?> module = new ModuleImpl<>(
    ...
    // 创造自动进食
    public static final DeferredHolder<Module<?>, Module<?>> CREATE_AUTO_FEED = MODULES != null ? MODULES.register(
        "create_auto_feed",
        () -> {
            ModuleImpl<?> module = new ModuleImpl<>(
                ModuleTypes.AUTO_FEED,
    ...
    // 创造伤害
    public static final DeferredHolder<Module<?>, Module<?>> CREATE_DAMAGE = MODULES != null ? MODULES.register(
        "create_damage",
        () -> {
            ModuleImpl<?> module = new ModuleImpl<>(
                ModuleTypes.DAMAGE,
    ...
    // 创造弹射物
    public static final DeferredHolder<Module<?>, Module<?>> CREATE_PROJECTILE = MODULES != null ? MODULES.register(
        "create_projectile",
        () -> {
            ModuleImpl<?> module = new ModuleImpl<>(
